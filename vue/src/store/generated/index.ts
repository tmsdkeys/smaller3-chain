...
import TmsdkeysSmaller3TmsdkeysSmaller3Smaller from './tmsdkeys/smaller3/tmsdkeys.smaller3.smaller'
...
export default { 
  ...
  TmsdkeysSmaller3TmsdkeysSmaller3Smaller: load(TmsdkeysSmaller3TmsdkeysSmaller3Smaller, 'tmsdkeys.smaller3.smaller'),
